...
class UnalignedDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        self.dir_A = os.path.join(opt.dataroot, opt.phase + '_A')  # create a path '/path/to/data/train_A'
        self.dir_B = os.path.join(opt.dataroot, opt.phase + '_B')  # create a path '/path/to/data/train_B'

        if opt.phase == "test" and not os.path.exists(self.dir_A) \
           and os.path.exists(os.path.join(opt.dataroot, "val_A")):
