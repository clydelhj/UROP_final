...
class SingleImageDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        self.dir_A = os.path.join(opt.dataroot, 'train_A')  # create a path '/path/to/data/train_A'
        self.dir_B = os.path.join(opt.dataroot, 'train_B')  # create a path '/path/to/data/train_B'
