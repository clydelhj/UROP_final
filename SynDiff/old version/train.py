...
def train_syndiff(rank, gpu, args):
    ...
    val_l1_loss=np.zeros([2,args.num_epoch,args.val_steps])
    val_psnr_values=np.zeros([2,args.num_epoch,args.val_steps])
    ...
    disc_non_diffusive_cycle1 = backbones.generator_resnet.define_D(input_nc=3, gpu_ids=[gpu])
    disc_non_diffusive_cycle2 = backbones.generator_resnet.define_D(input_nc=3, gpu_ids=[gpu])
